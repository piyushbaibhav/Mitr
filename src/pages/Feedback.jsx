  ...
  <section className="mb-32">
    <div className="flex flex-wrap">
      <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-7/12 md:px-3 lg:px-6">
        ...
        <p className="mb-2 font-bold">When will I receive the Requested Products? </p>
      ...
      <div className=" my-auto md:w-5/12 bg-transparent md:px-3 lg:px-6">
        ...
        <form>
          ...
          <div className="relative bg-white rounded-lg mb-6">
            <input type="email"
              className="w-full" placeholder="Email address" />
            <label
              className="pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary"
              for="exampleInput91">
            </label>
          ...
          <div className="relative  bg-white rounded-lg mb-6">
            <textarea
              className="w-full" rows="10" placeholder="Your message"></textarea>
            <label for="exampleFormControlTextarea1"
              className="pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary"></label>
          </div>

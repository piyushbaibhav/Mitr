...
export default function Dashboard() {
  ...
  <nav className=''>
    <ol class="flex items-center w-full text-sm font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base">
      ...
      <div className='m-5'>
        Welcome User!<br/>
        <div>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Unde quasi sint dicta magnam nemo, asperiores et, fugit dolore beatae fugiat pariatur eum quas error officiis corrupti aut dolor rerum perspiciatis.</div>
        <button className='border bg-blue-500'> Proceed </button>
      </div>
    </>
  )
}
